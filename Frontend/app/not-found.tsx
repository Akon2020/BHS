    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-background via-background to-primary/5 px-4">
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="relative mb-8">
          <h1 className="text-[clamp(8rem,20vw,16rem)] font-bold text-primary/10 leading-none select-none">
            404
          </h1>
        ...
        <div className="space-y-4 mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Comme des pèlerins qui cherchent leur chemin, nous sommes là pour
            vous guider. Cette page semble s&apos;être égarée, mais ensemble
